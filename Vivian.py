    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            if numbers and message:
                pywhatkit.sendwhatmsg(numbers, message, current_hour, next_minute)
            ...
            speak("Bhuvan please enter the YouTube video link which you want to download")
            links = input("Enter the YOUTUBE video link: ")
            links
            yt = YouTube(links)
            yt.streams.get_highest_resolution().download()
            speak(f"Bhuvan downloaded {yt.title} from the link you provided into the main folder")
